...
gcc -o ./../obj/scarlregister.o -c scarlregister.c
gcc -o ./../obj/lex.yy.o -c lex.yy.c
gcc -o ./../obj/y.tab.o -c -Wno-int-conversion y.tab.c
...
gcc -o ./../bin/scarlcompile.exe ./../obj/linked_list.o ./../obj/stringstack.o ./../obj/scarlregister.o ./../obj/lex.yy.o ./../obj/y.tab.o ./../obj/scarlastnode.o ./../obj/scarlsymboltable.o ./../obj/scarlcodegenerator.o ./../obj/scarltypes.o